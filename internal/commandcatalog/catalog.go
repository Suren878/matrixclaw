...
func Catalog() []CommandSpec {
	return []CommandSpec{
		...
		{ID: CommandProvider, Command: "/provider", Description: "Provider", Menu: false, Public: false},
		{ID: CommandPermissions, Command: "/permissions", Aliases: []string{"mode"}, Description: "Permission mode", Menu: false, Public: false},
