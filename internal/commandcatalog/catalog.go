...
func Catalog() []CommandSpec {
	return []CommandSpec{
		...
		{ID: CommandProvider, Command: "/provider", Description: "Provider", Menu: true, Public: false},
		{ID: CommandPermissions, Command: "/permissions", Aliases: []string{"mode"}, Description: "Permission mode", Menu: true, Public: false},
